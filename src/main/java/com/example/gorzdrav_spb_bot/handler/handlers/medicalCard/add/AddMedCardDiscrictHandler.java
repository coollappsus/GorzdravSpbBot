...
@Component
@AllArgsConstructor
public class AddMedCardDiscrictHandler implements TelegramUpdateMessageHandler {

    private static final String RESPONSE_TEXT_LPU = "Выберите лечебно профилактическое учреждение";

    private final GorzdravService gorzdravService;
    private final KeyboardFactory keyboardFactory;
    private final AddMedCardLpuHandler addMedCardLpuHandler;
    ...
    public BotApiMethod<?> processMessage(Message message, UserState userState) {
        ...
        userState.setHandler(addMedCardLpuHandler);
